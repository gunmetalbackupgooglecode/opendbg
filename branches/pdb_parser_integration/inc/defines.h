...
#ifdef _M_IX86
 #define fastcpy(a,b,c) memcpy(pv(a), pv(b), (size_t)(c) / 4)
#else
 #define fastcpy(a,b,c) memcpy(pv(a), pv(b), (size_t)(c) / 8)
#endif

#define memcpy(a,b,c) memcpy((char*)(a), (char*)(b), (size_t)(c))
#define memset(a,b,c) memset((char*)(a),(char)(b),(size_t)(c))
