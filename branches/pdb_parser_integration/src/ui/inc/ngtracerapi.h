...
TRACERAPI	BOOL				trc_enable_bp(ULONG SessId, ULONG bp_type, PVOID addr, ULONG TID, BOOL bEnable);
...
#define		TRC_OPT_PROTECT_DRS					0x100
#define		TRC_OPT_PROTECT_TF					0x200
