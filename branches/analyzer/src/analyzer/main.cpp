...
/* Возвращаемые значения:
	= 0 - блок завершился врезанием в уже проанализированный блок (неправильный блок или прыжок в середину блока)
	< 0 - блок заверешился ошибкой анализа (неправильный блок или недостаточно памяти)
